			...
			<table>
				...
				<tr>
					...
					<td><input type="text" placeholder="Enter your Address here"
						name="userAddress" required="required"></td>
				</tr>
				<tr>
					<td>DOB:</td>
				...
				<tr>
					...
					<td><input type="password" required="required"
						placeholder="Enter your password here" name="userPassword"></td>
				</tr>

				<tr>
					<td>PAN Card No.:</td>
					<td><input type="text" required="required"
						placeholder="Enter your PAN here" name="panNo"></td>
				</tr>
